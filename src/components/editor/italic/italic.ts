...
function findItalic(line: string, offset: number, cursor: number) {
...
export const italicPlugin = ViewPlugin.fromClass(
  class {
    ...
    build(view: EditorView): DecorationSet {
      ...
      for (let i = 1; i <= doc.lines; i++) {
        ...
        const deco = findItalic(line.text, line.from, cursor);
