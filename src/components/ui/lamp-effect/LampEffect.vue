  ...
  <div :class="cn(
    ...
    <div class="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
      ...
      <div :style="{
        ...
        class="animate-conic-gradient bg-gradient-conic absolute inset-auto right-1/2 h-56 w-60 overflow-visible from-rosepine-love via-transparent to-transparent text-white opacity-50 [--conic-position:from_70deg_at_center_top]">
        <div
      ...
      <div :style="{
        ...
        class="animate-conic-gradient bg-gradient-conic absolute inset-auto left-1/2 h-56 w-60 from-transparent via-transparent to-rosepine-love text-white opacity-50 [--conic-position:from_290deg_at_center_top]">
        <div
      ...
      <div
        class="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-rosepine-love opacity-50 blur-3xl">
      </div>


      <div
        class="animate-spotlight absolute inset-auto z-30 h-36 w-32 -translate-y-24 rounded-full bg-rosepine-love blur-2xl">
      </div>


      <div class="animate-glowing-line absolute inset-auto z-50 h-0.5 w-60 -translate-y-28 bg-rosepine-love"></div>
